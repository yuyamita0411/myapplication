            ...
            <div class="d-inline-block w-100 position-relative">
                <div class="col-12 col-md-6 float-left p-2">
                    <div class="float-left cursor">
                        <img class="d-inline-block searchicon" src="{{ secure_asset('asset/personicon.png') }}">
                        担当者
                    </div>
                ...
                <div class="col-12 col-md-6 float-left p-2">
                    <div class="float-left cursor">
                        <img class="d-inline-block searchicon" src="{{ secure_asset('asset/groupicon.png') }}">
                        グループ名
                    </div>
                ...
                <div class="col-12 col-md-6 float-left p-2">
                    <div class="float-left cursor">
                        <img class="d-inline-block searchicon" src="{{ secure_asset('asset/deadlineicon.png') }}">
                        締切
                    </div>
                ...
                <div class="col-12 col-md-6 float-left p-2">
                    <div class="float-left cursor">
                        <img class="d-inline-block searchicon" src="{{ secure_asset('asset/statusicon.png') }}">
                        ステータス
                    </div>
        ...
        <div class="m-auto">
            <div class="gridinside  col-md-12 m-auto pt-3 pb-5 pl-0 pr-0 bg-white">
                <div class="col-12 pb-1 pr-2 pl-2 m-auto">
                    ...
                    <img id="commentbutton" class="d-inline-block searchicon float-right cursor" src="{{ secure_asset('asset/addcomments.png') }}">
                </div>
            </div>
        </div>
    </div>
...
import {Validation} from '../../js/validation.js'
    ...
    SearchArea.addEventListener('input', (e) => {
        commonloadMotion('CommentDisplayArea', "{{ secure_asset('asset/loadingicon.png') }}");
